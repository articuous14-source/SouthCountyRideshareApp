...
const DEFAULT_RATES = {
    'john-wayne-sna': {
        ...
        rates: [
            { vehicle: 'Sedans', price: '$50' },
            { vehicle: 'SUV', price: '$80' },
            { vehicle: 'XL SUV', price: '$90' }
        ],
        additionalFees: [
            { name: 'Baggage Claim Meeting', description: 'A flat fee applies when the driver meets the passenger in the baggage claim area.', price: '$25' },
